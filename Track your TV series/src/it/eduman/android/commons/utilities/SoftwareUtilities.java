...
import it.eduman.android.trackYourTVseries.R;
...
//		MyInfoDialogFactory(context, context.getResources().getString(msg), false, null);
...
//		MyInfoDialogFactory(context, context.getResources().getString(msg), showNegativeButton, action);
...
//		MyInfoDialogFactory(context, msg, false, null);
		MyGenericDialogFactory(context, R.string.info, msg, false, null);

	}
	
//	public static void MyInfoDialogFactory(final Context context, String msg, boolean showNegativeButton, final ActionTask action){
//				
////		AlertDialog.Builder builder = new AlertDialog.Builder(context);
////		builder.setMessage(msg).setTitle(R.string.info);
////		builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
////			public void onClick(DialogInterface dialog, int id) {
////				if (action != null){
////					action.onPositiveResponse();
...
//		MyErrorDialogFactory(context, context.getResources().getString(msg), false, null);
...
//		MyErrorDialogFactory(context, context.getResources().getString(msg), showNegativeButton, action);
...
//		MyErrorDialogFactory(context, msg, false, null);
		MyGenericDialogFactory(context, R.string.error, msg, false, null);
	}
	
//	public static void MyErrorDialogFactory(final Context context, String msg, boolean showNegativeButton, final ActionTask action){
//		MyGenericDialogFactory(context, R.string.error, msg, showNegativeButton, action);
////		AlertDialog.Builder builder = new AlertDialog.Builder(context);
