...
public class HttpConnection {
	...
	private static class HttpGetCallable implements Callable<String> {
		...
		@Override
		public String call() throws TvdbAPIException {
			try {
				...
				if (responseCode != 200){
					throw new TvdbAPIException(con.getResponseMessage());
				} else {
	...
	public static String sendGet(String uri) throws TvdbAPIException{
